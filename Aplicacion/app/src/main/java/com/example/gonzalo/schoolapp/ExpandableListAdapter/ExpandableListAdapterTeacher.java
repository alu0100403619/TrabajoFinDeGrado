 ...
 */
public class ExpandableListAdapterTeacher extends BaseExpandableListAdapter {

    private Context context;
    private List<String> listDataHeader;
    private HashMap<String, List<Teacher>> listDataChild;

    public ExpandableListAdapterTeacher (Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        final Teacher childText = (Teacher) getChild(groupPosition, childPosition);
