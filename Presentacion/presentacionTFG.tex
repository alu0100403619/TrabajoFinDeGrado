...
\defbeamertemplate*{title page}{AGH}[1][]
{
  ...
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      \hfill \includegraphics[width=0.8\linewidth]{Images/App/welcome.png}
    \end{column}
  \end{columns}
...
\begin{document}
	...
	\frame{\frametitle{Índice}\tableofcontents}
		...
		\section{Especificación de Requisitos}
			\include{Capitulos/Cap2_Requisitos}
		\section{Herramientas Software}
			\include{Capitulos/Cap3_HerrSoft}
		\section{Descripción de \SchollApp}
			\include{Capitulos/Cap4_Descripcion}
		\section{Desarrollo de la Aplicación}
			\include{Capitulos/Cap5_Desarrollo}
		\section{Problemas}
			\include{Capitulos/Cap6_Problemas}
		%\section{Despliegue}	
			%\include{Capitulos/Cap7_Despliegue}
		\section{Resumen y conclusiones (inglés)}
			\include{Capitulos/Cap8_Conclusiones}
